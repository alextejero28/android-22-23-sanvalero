...
public class HistoricoPeliculasAdapter extends RecyclerView.Adapter<HistoricoPeliculasAdapter.ViewHolder>{

    private ArrayList<Pelicula> lstpeliculas;
    private Context mContext;

    public HistoricoPeliculasAdapter(ArrayList<Pelicula> lstpeliculas, Context mContext) {
        this.lstpeliculas = lstpeliculas;
        this.mContext = mContext;
    }

    @Override
    public HistoricoPeliculasAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_pelicula, parent, false);
        return new HistoricoPeliculasAdapter.ViewHolder(view);
    }

    //TAKE DATA
    @Override
    public void onBindViewHolder(HistoricoPeliculasAdapter.ViewHolder holder, int position) {
        Pelicula peli = lstpeliculas.get(position);
