package com.svalero.skill6.adapters;
...
import com.svalero.skill6.R;
import com.svalero.skill6.networking.ProductResult;
...
public class RVRetrofitAdapter extends RecyclerView.Adapter<RVRetrofitAdapter.RVHolderRetrofit> {
    ...
    public void onBindViewHolder(@NonNull RVRetrofitAdapter.RVHolderRetrofit holder, int position) {
        ...
        Glide.with(mContext).
                load(productResults.get(position).getProductImage()).placeholder(R.drawable.ic_launcher_background).
